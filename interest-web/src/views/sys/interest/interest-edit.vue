    ...
    <div style="margin: 20px;">
        <Form ref="entity" :model="entity" :rules="ruleNew" :label-width="80">
            ...
            <Form-item label="简介：" prop="info">
                <Input v-model="entity.info" type="textarea" :autosize="{minRows: 4,maxRows: 5}"
            ...
            <Form-item label="详情：" prop="content">
                ...
                <interest-quill-editor v-bind:interestContent="interestContent" class="editor"
                                       @editor-change="e=>{contentGet(e)}"></interest-quill-editor>
            </Form-item>
            <FormItem>
