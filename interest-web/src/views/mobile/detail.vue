    ...
    <div id="mywork">
        <div class="page-header-main">
            <div class="box-flex width-80 margin-auto margin-top-2 flex-direction-column flex-justify-center flex-items-center">
                ...
                <div class="detailContent ql-editor" v-html="insterest.content"
                ...
                <div style="width: 100%;margin: 10% 0 20px 0">
                            ...
                            <div class="layout-left" style="margin-top: 2px;">
                                <a :href="item.githuburl" target="_blank">
                                    ...
                                    <img :src="item.headimg"
                                         style="width: 30px;height: 30px;border-radius: 100%;margin-top: 6px;">
                                </a>
                            </div>
                    ...
                    <div style="margin-top: 20px">
                        <Page :total="total" :page-size="pageInfo.pageSize" show-total
                ...
                <div class="box-flex margin-auto margin-top-2 flex-direction-column flex-justify-center flex-items-center"
