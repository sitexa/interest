...
<template>
    <div class="mobild-layout">
            ...
            <Header style="position: fixed;width: 100%;background:#fff;padding:0 0;z-index: 1000; line-height:0;">
                <div style="width: 95%;margin: 0 auto">
                    ...
                    <Dropdown v-if="loginFlag" trigger="click" class="layout-nav" @on-click="m=>{dropdownClick(m)}">
                        <img style="width: 40px;height: 40px; margin-top: 12px;border-radius: 100%;"
                             :src="user.headimg"></img>
        ...
        <Modal :mask-closable="false" :visible.sync="emailModal" :loading="loading" v-model="emailModal" title="联系管理员"
               @on-ok="emailOk('email')" @on-cancel="cancel()">
